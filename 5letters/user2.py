...
#будет обрабатывать входящие сообщения.
def receive():
    while True:
        ...
        if window.number == 2:
            ...
            window.messages.pop()
#отвечает за сетевое взаимодействие между игроками и обработку сообщений, поступающих от другого игрока.
#Он также связывает функции, отвечающие за логику игры, с графическим интерфейсом, что позволяет игроку управлять игрой через интерфейс.
